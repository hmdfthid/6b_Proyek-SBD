...
export default () => {
  ...
  function add() {
    history.push("/history/add");
  }

  function edit(id) {
    history.push(`/history/edit/${id}`);
  }

  function hapus(id) {
      axios.delete(`http://localhost:8000/peminjaman/${id}`)
  ...
  useEffect(() => {
      axios.get('http://localhost:8000/peminjaman')
      .then(function (response) {
    ...
    <>
      <Card border="light" className="shadow-sm mb-4">
        <MaterialTable
            ...
            columns={[
            { title: 'ID', field: 'id' },
              { title: 'Kode Buku', field: 'kode_buku' },
              { title: 'ID Peminjam', field: 'id_peminjam' },
              { title: 'Tanggal Peminjaman', field: 'tanggal_peminjaman' },
              { title: 'Tanggal Pengembalian', field: 'tanggal_pengembalian' },
              { title: 'Status Peminjaman', field: 'status_peminjaman' },
